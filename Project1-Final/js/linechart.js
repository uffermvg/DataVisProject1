class LineChart {
  ...
  initVis() {
    ...
    vis.containerWidth = 500;
    vis.containerHeight= 200;
    vis.margin = {top: 25, right: 30, bottom: 30, left: 50};
    ...
    vis.trackingArea
        ...
        .on('mousemove', function(event) {
          ...
          vis.tooltip.select('circle')
              .attr('transform', `translate(${vis.xScale(d.key)},${vis.yScale(d.value)})`);
          
          vis.tooltip.select('text')
              .attr('transform', `translate(${vis.xScale(d.key)},${(vis.yScale(d.value) - 15)})`)
